...
## FOM MESH SIZE DATA FOR THE REFERENCE SNAPSHOT ##
x_cells = 250 # NUMBER OF CELLS ALONG X
y_cells = 75 # NUMBER OF CELLS ALONG Y
...
def shift_plot(idx, epoch, x_ref, y_ref, f_ref, shifted_x, shifted_y, f_test, loss):
    ...
    Z = clean(f_test).reshape(y_tmp.size, x_tmp.size)
